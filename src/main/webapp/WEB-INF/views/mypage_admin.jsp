	...
	<div style="padding:50px 50px 50px 300px;" > 
		...
		<div class="col-sm-1 mr-5">
			...
			<img src="${pageContext.request.contextPath}/resources/images/face.PNG" width = "100" height = "100" /> <br/>
           	<div  style = " white-space : nowrap;  text-overflow:ellipsis;">  관리자 ${vo.name}님 <br/>
        ...
        <div class="col-sm-8 ">
			<div  style = " white-space : nowrap;  text-overflow:ellipsis;"> <h3>판매 상품 내역</h3> 		 
		                  ...
		                  <tr>
				                ...
				                <c:if test = "${vo.base64 ne null }">
				              	...
				              	<c:if test = "${vo.base64 eq null }">
				                    ...
				                    <td style="border:1px solid #D6D6D6;">
				                    	<a href="${pageContext.request.contextPath}/member/mypage/admin/delete?name=${vo.name}" >삭제 </a>
				                    </td>
