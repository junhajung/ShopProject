   ...
   <!--  전체 카테고리 -->
	...
	<br/><br/><hr/>
		...
		<div class = "col-sm-9" style="border:1px solid #D6D6D6; background-color : #F8F9FA; "><h3> 공지사항 </h3></div>
   			 <br/> <br/> <br/> <br/> 
 			 <div class="col-sm-9 " style="height:200px, width:200px; border:1px solid #D6D6D6; height:1000px; ">
 			 
 			 <br/><br/>
 			 <table class="table" style="border:1px solid #cccccc">
		        <thead>
		            <tr >
		                <th style="border:1px solid #D6D6D6; width:1500px;">공지사항</th>
		                <th style="border:1px solid #D6D6D6; width:500px;">등록일자</th>
			...
			<form action="${pageContext.request.contextPath}/notice" method="get" class="form-line"  >
								...
								.twbsPagination(
										{
											...
											onPageClick : function(event, page) {
												window.location.href = "${pageContext.request.contextPath}/notice?txt="+'${param.txt}'+ "&page="+page;
											}
										});
					});
				</script>
